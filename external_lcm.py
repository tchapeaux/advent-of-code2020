# Below is from https://math.stackexchange.com/a/3864593
...
assert arrow_alignment(red_len=9, green_len=15, advantage=3) == 18
assert arrow_alignment(red_len=30, green_len=38, advantage=6) == 120
try:
    arrow_alignment(red_len=9, green_len=12, advantage=5)
except ValueError:
    pass
